<div class="c-video-module c-video-module--sm js-video">
    <div class="c-video-module__media">
        <div class="c-video" style="background-image: url(./static/img/img-video-bg.jpg)">
            <video class="c-video__player js-viewer js-video-module" preload="auto">
                <source src="./static/img/example-video.mp4" type="video/mp4">
            </video>
                ...
                <div class="c-controls">
                    ...
                    <div class="c-controls__progress">
                         <div class="c-progress">
                             ...
                             <div class="c-progress__info t-caption"><span class="js-current-time">1:45</span><span class="js-full-time">6:45</span></div>
                         </div>
                    </div>
        ...
        <div class="l-inner">
            <div class="c-video-module__content">
                <div class="c-video-teaser">
                    <h4 class="c-video-teaser__heading t-headline-4 t-bold">
                        Data privacy
                    </h4>
                    <h2 class="c-video-teaser__text t-headline-2">
                        You trust us with <br>your data. It’s our responsibility to be transparent about the data that we collect
                    </h2>
                </div>
                <a class="c-play js-play" href="#">
                    ...
                    <div class="c-play__text t-button">
                        <p>Watch the video</p>
                        <p class="t-regular">Transparency with data<span class="js-time">2.25</span></p>
                    </div>
                </a>
            </div>
        </div>
